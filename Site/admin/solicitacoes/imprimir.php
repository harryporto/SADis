<?php
	...
	//auditoria ends
		...
		$html = "<b><div style='margin-left:39%; margin-top:10%;'>SADis – Sistema de Aproveitamento de Disciplinas</b><br></div>
				<b><div style='margin-left:42%';>UFBA </b>- Universidade Federal da Bahia<br><br></div>
